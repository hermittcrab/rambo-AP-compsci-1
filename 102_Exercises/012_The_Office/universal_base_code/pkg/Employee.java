...
public class Employee {
	...
	double annual;
	double raise;
	// Stores monthly salary of the Employee
	...
	public Employee() {		// Default Constructor
		...
		salary = 6583.33;
		raise = salary + (salary*(25.0/100.0));	
	...
	public void raiseSalary(int percent){	// Increases Employee salary by percent percent
		salary = salary + (salary*(25.0/100.0));	// Ex: Salary is 50,000 -> 	50,000 + (50,000 * (0.1)) This is a 10% increase
		return;
	}
	...
	public void employeeToString(){					// Prints all values of the Employee	
		...
		System.out.println("Employee Raise: " + raise);
