...
class starter {
		...
		*/
		...
		if(choice.equals("file")){
			System.out.println("----------");
                ...
                System.out.println("Choose a phrase/word to check: ");
                ...
                System.out.println("Choose the num of words of text: ");
	...
	*/
	...
	for(int i = 0; i < arr.length; i++){
		...
		return a;	// Dummy value, delete when needed.
	}
